<?php
    ...
    require_once 'mysqlConnection.php'; //Requiere el archivo 'mysqlConnection.php 
    ...
    $sqlSyntax= 'SELECT mail,pass FROM usuario WHERE mail = "'.$_POST['inUser'].'" AND pass = "'.$_POST['inPass'].'"'; //Se crea la sintaxis para la base de datos 
    $sqlQuery= mysql_query($sqlSyntax); //Se ejecuta el query de $sqlSyntax 
    $sqlSyntax2= 'SELECT mail FROM usuario WHERE mail = "'.$_POST['inUser'].'"';  //Se crea la siguiente sintaxis 
    ...
    { 
        ...
        header('Location: index.php'); 
        $_SESSION['error']= 'Bienvenid@ '.$_SESSION['nombre'].''; //Le asigna a la variable de sesión un mensaje de bienvenida con el nombre del usuario 
