...
<head>
    ...
    <script type="text/javascript">
    	$(document).on('click', '.paginationbutton', function () {    
			...
			//alert(subsubcategoria);
				$("#working").html('<div class="container" style="margin-top: 100px;"><div class="row" style="margin-left:300px;"><img src="img/loading/loading.gif"> </div></div>');
        		$.ajax({
		          type: "POST",
		          url: "getlistarapida.php",
		          data: {pagina:pagina},
		          cache: false,
		          success: function(result){
		            if (result == ''){
   ...
   <script type="text/javascript">
   		$( document ).ready(function() {
   			//cargar todos los productos que el usuario tiene en sus listas
   			$.ajax({
   				type: "POST",
   				url: "getlistarapida.php",
   				data: {},
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="listas.php">Administrar Listas</a></li>
