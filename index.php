...
<body>
  <?php
     ...
     if (isset($_SESSION['facebook'])){
      ...
      //echo '<a href="fb/app/logout.php" class="btn btn-danger">Cerrar sesión</a>';
    }
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          <form class="form-signin" style="background-image: url('img/marco_login.png');" id="loginForm" method="POST" action="login.php">
              ...
              <a href="<?php echo $helper->getLoginUrl($config['scopes']); ?>" class="btn btn-lg btn-primary btn-block">Iniciar sesión con Facebook!</a>
            </form>  
          </div>
      </div>
    </div>
