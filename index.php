...
<head>
  ...
  <script type="text/javascript"> 
    ...
    { 
      ...
      if(Pass == false){
        var error = true;
        var errormsg = 'Su Contraseña debe tener al menos 8 caracteres.';
      }
    ...
    <?php
      ...
      if(isset($_SESSION['user'])){ //Si existe la variable de sesión 'user':  
        ...
        if(isset($_SESSION['time'])){ //Si existe la variable de sesión 'time': 
          ...
          if($timeCount > 200){ //Si el valor de la variable timeCount es superior a 1200 (segundos, 20 minutos):  
      ...
      if(isset($_SESSION['error'])){ //Si existe la variable de sesión 'error': 
        echo '<div class="alert alert-danger" id="error"><p>'.$_SESSION['error'].'</p></div>'; //Muestra un div con el mensaje de error contenido en la variable de sesión 'error' 
      ...
      if(isset($_SESSION['user'])){  //Si existe la variable de sesión 'user' 
        ...
        } //Redirecciona a la carpeta 'home' 
      } 
        ...
        <div class="row">
          ...
          <div class="col-xs-6">
            <form class="form-signin" style="background-image: url('img/marco_login.png');" id="loginForm" method="POST" action="login.php">
                ...
                <input type="password" id="inPass" name="inPass" class="form-control" placeholder="Contrasena" onKeyPress="return submitenter(this,event)">
                <button type="button" id="inForm" onclick="CheckForm()" value="Iniciar Sesión"><img width="250" class="login" src="img/botones/iniciar_sesion.png" alt="SomeAlternateText"></button>
                <!--<input type="button" class="btn btn-lg btn-info btn-block" id="" onclick="CrearCuenta()" value="Crear Cuenta">-->
                <a href="#crearCuenta" id="buttonModalCrearCuenta" class="inForm" role="button" data-toggle="modal"><img style="margin-bottom: 10px;" width="250" class="login" src="img/botones/crear_cuenta.png" alt="SomeAlternateText"></a>
                <a href="<?php echo $helper->getLoginUrl($config['scopes']); ?>" class="inForm"><img width="250" class="login" src="img/botones/facebook.png" alt="SomeAlternateText"></a>
              </form>  
            </div>
        </div>
      </div>
        ...
        <div class="modal-body">
          ...
          <form class="form-horizontal">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="Email" name="Email" class="form-control" type="text" placeholder="ejemplo@mail.com" class="input-large" required="">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="nombre" name="nombre" class="form-control" type="text" placeholder="Nombre" class="input-large" required="">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="apellido" name="apellido" class="form-control" type="text" placeholder="Apellido" class="input-large" required="">
                </div>
              </div>
              ...
              <br>
              <div class="control-group">
                <label class="control-label" for="humancheck">Sexo:</label>
                <div class="controls">
                  <label class="radio inline" for="humancheck-0">
                    <input type="radio" name="humancheck" id="humancheck-0" value="0" checked="checked">Hombre</label>
                  <label class="radio inline" for="humancheck-1">
                    <input type="radio" name="humancheck" id="humancheck-1" value="1">Mujer</label>
                </div>
              </div>
  ...
  <script type="text/javascript">
      $("#confirmsignup").click(
        ...
        var sexo = $('input[name=humancheck]:checked').val();
        ...
        if(mail == "" || nombre == "" || apellido == "" || pass == ""){
          ...
          alert("Tu Contraseña debe tener al menos 8 caracteres. Inténtalo denuevo.")
        }
        else{
          ...
          if(filter.test(mail)){
            ...
            $.ajax({  
              type: "POST",
              url: "register.php",
              data: {mail:mail, nombre:nombre, apellido:apellido, pass:pass, sexo:sexo},
              cache: false,
              success: function(result){
                if(result == "1"){
                  ...
                  //alert(result);
                  //location.reload();
                  alert("Este mail ya esta registrado, intenta con otro!")
    ...
    <input type="text"  placeholder="Contrasena" onKeyPress="return avoidtab(this,event)">
</body>
</html>
